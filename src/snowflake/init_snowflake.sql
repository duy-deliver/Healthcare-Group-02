"FVHIS_DOC"."DISEASE_DIAGNOSIS_UPTODATE"-- Set up Warehouse
CREATE WAREHOUSE IF NOT EXISTS QOOBEE_WH WITH WAREHOUSE_SIZE = 'XSMALL' WAREHOUSE_TYPE = 'STANDARD' AUTO_SUSPEND = 600 AUTO_RESUME = TRUE;
